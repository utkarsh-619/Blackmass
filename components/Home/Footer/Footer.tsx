...
=======
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-teal-600 items-center flex-col">
        <Image
            src = {logo}
            alt='logo'
            height={100}
        ...
        />
        <h3 className='text-2xl font-bold'>Black Mass Energies</h3>
    </div>
...
>>>>>>> f1a80515ca3cffa2e033ad3ece15a8dc06ab3214
    )
}
